          ...
          blocks: [
            ...
            },
            {
              ...
              items: [
                ...
                'Editing the dates never touches the Hours box. Stretch an approved single day into a week and it stays billed at the original hours — the row happily reads "7d / 8h" and the balance under-charges silently (or over-charges if you shrink the range). Every add form auto-fills hours from the dates; Edit is the one form that does not, and nothing flags the mismatch.',
