          ...
          blocks: [
            ...
            },
            {
              ...
              items: [
                ...
                'The quick call-out form — clicking a chip in the attendance roll — never checks the vacation cap. Switch its Type to Vacation and it books a third or fourth engineer straight to approved: no red box, no override reason, no OVERRIDE badge on the record. Only the heatmap turning red afterwards shows it happened. The cap guard lives in Add PTO and the pending queue only.',
