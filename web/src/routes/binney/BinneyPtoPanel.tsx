...
import { PtoCbaPreloadModal, type CbaPreloadRow } from '../../components/PtoCbaPreloadModal';
 ...
 *  dividers and the Upcoming-approved "Later" bucket. */
...
function TodayAttendance({
  ...
  // row with the rotated heatmap (pinned at 350px), so the minimums are
...
function CapHeatmap({ requests, onPickDate }: {
  ...
  // on the grid's scroll window below).
